            ...
            {questions.map((question, index) => (
              ...
              >
                <p className="flex items-center rounded text-xs p-2 cursor-pointer">
                  <span className="h-8 w-8 bg-primary rounded-full flex justify-center items-center text-green-800 mr-3">
                    {index + 1}
                  </span>
        ...
        <div className="md:w-[30%] w-full p-4">
          {showResult && (
            <div>
              ...
              <button
                onClick={restartQuiz}
                className="bg-primary text-white w-full py-2 rounded mt-16"
              >
                Restart
              </button>
            </div>
